...
func TestSetupEnv(t *testing.T) {
	...
	for idx, tc := range cases {
		...
		cmd := PrepareBaseCmd(demo, "DEMO", "/qwerty/asdfgh")
		cmd.Exit = func(int) {}
...
func TestSetupConfig(t *testing.T) {
	...
	for idx, tc := range cases {
		...
		cmd := PrepareBaseCmd(boo, "RD", "/qwerty/asdfgh")
		cmd.Exit = func(int) {}
...
func TestSetupUnmarshal(t *testing.T) {
	...
	for idx, tc := range cases {
		...
		cmd := PrepareBaseCmd(marsh, "MR", "/qwerty/asdfgh")
		cmd.Exit = func(int) {}
...
func TestSetupTrace(t *testing.T) {
	...
	for idx, tc := range cases {
		...
		cmd := PrepareBaseCmd(trace, "DBG", "/qwerty/asdfgh")
		cmd.Exit = func(int) {}
